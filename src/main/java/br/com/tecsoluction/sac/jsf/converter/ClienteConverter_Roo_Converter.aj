...
import br.com.tecsoluction.sac.jsf.converter.ClienteConverter;
...
privileged aspect ClienteConverter_Roo_Converter {
    ...
    declare @type: ClienteConverter: @FacesConverter("br.com.tecsoluction.sac.jsf.converter.ClienteConverter");
